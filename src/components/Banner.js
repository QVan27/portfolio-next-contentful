...
import Profile from "@/assets/images/quentin.jpeg"
    ...
    <Container>
      ...
      <div className='min-h-screen grid grid-cols-12 xl:grid-cols-24 gap-x-2.5 items-center'>
        <h1 className='col-start-2 col-end-12 xl:col-start-3 xl:col-end-23 flex flex-col content'>
          <span className={`${anton.className} text-center title-border`}>DEVELOPER</span>
          <div className='flex flex-wrap justify-center xl:gap-x-12 texts lg:items-center'>
            <p className={`${maitree.className}`}>Passionate about the world of the web and applications, I can be a <span>source of ideas</span> to bring all your projects to fruition.</p>
            <span className={`${anton.className} title-full text-center`}>WEB</span>
          </div>
          <span className={`${anton.className} hidden xl:block text-center title-border`}>WEB MOBILE</span>
        </h1>
      </div>
    </Container>
  )
